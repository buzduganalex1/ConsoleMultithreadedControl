...
///
//static void SomethingToInvokeItAll()
//{
//	var cancellationTokenSource1 = new CancellationTokenSource();
//var cancellationTokenSource2 = new CancellationTokenSource();

//SomethingToWaitForTheTaskToFail(cancellationTokenSource1, "1");
//SomethingToWaitForTheTaskToFail(cancellationTokenSource2, "2");

//cancellationTokenSource1.Cancel();
//}

//static void SomethingToWaitForTheTaskToFail(CancellationTokenSource source, string id)
//{
//	try
//	{
//		var t = new Task(() => ActionToExecuteInTask(source.Token, id), source.Token);
//		t.Start();
//	}
//	catch (Exception)
//	{
...
//static void ActionToExecuteInTask(CancellationToken ct, string id)
//{
//	if (ct.IsCancellationRequested)
//	{
